...
_C.DATASET.DEN_FACTOR = 200
# training
_C.TRAIN = CN()

_C.TRAIN.IMAGE_SIZE = [512, 1024]  # height* width
_C.TRAIN.ROUTE_SIZE = [256, 512]   # height* width
_C.TRAIN.BASE_SIZE = 2048
_C.TRAIN.DOWNSAMPLERATE = 1
_C.TRAIN.FLIP = True
_C.TRAIN.MULTI_SCALE = True
_C.TRAIN.SCALE_FACTOR = 16
_C.TRAIN.COUNTER = 'normal'
...
_C.TRAIN.AMSGRAD = False  # for Adam
_C.TRAIN.IGNORE_LABEL = -1

_C.TRAIN.SCHEDULER_NAME='WarmupMultiStepLR'
_C.TRAIN.WARMUP_FACTOR=0.001
_C.TRAIN.GAMMA=0.1
_C.TRAIN.WARMUP_ITERS=20
_C.TRAIN.MILESTONES= [50, 150, 300]

_C.TRAIN.BEGIN_EPOCH = 0
_C.TRAIN.END_EPOCH = 484
_C.TRAIN.EXTRA_EPOCH = 0
_C.TRAIN.VAL_SPAN = [-_C.TRAIN.END_EPOCH]
_C.TRAIN.RESUME = False
_C.TRAIN.RESUME_PATH = None
