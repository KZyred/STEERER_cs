...
mode = 'train'
Root = '/mnt/petrelfs/hantao/ProcessedData/NWPU'
img_path = '/mnt/petrelfs/hantao/ht/ProcessedData/NWPU/images'
dst_json_path = '/mnt/petrelfs/hantao/ProcessedData/NWPU/jsons'
mask_path = '/mnt/petrelfs/hantao/ProcessedData/NWPU/mask_50_60'
cycle  =False
